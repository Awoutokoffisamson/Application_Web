...
model = joblib.load('co2_prediction_app/trained_model.pkl')  # Assurez-vous que le modèle est dans le même répertoire
data = pd.read_csv('co2_prediction_app/Final_data.csv')  # Assurez-vous que le fichier CSV est dans le même répertoire
model_columns = joblib.load('co2_prediction_app/model_columns.pkl')  # Charger les colonnes du modèle
