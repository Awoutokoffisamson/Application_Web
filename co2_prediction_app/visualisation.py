...
def afficher_visualisation(data):
    set_background("co2_prediction_app/logo4.jpg")  # Assurez-vous que le chemin de l'image est correct
    ...
    if st.session_state.show_map:
        ...
        afficher_carte("co2_prediction_app/Final_data2.xlsx")

# Charger les données
data = pd.read_csv("co2_prediction_app/Final_data.csv")
